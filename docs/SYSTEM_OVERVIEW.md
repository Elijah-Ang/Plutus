...
- **Proposal capacity line**: The digest includes one compact proposal-capacity line with used/remaining daily capacity, suppressed setup count, and the top recent blocker. It is informational only and does not create proposals, approvals, or orders.
