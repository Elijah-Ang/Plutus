...
REQUIRED_RUNTIME_TABLE_COLUMNS = {
    ...
    "order_intents": {"id", "logical_action_key", "client_order_id", "reserved_notional", "reserved_stop_risk", "state", "trading_mode", "strategy_registry_snapshot_id", "strategy_sleeve", "sleeve_allocation_id", "sleeve_notional_ceiling", "sleeve_stop_risk_ceiling", "incremental_risk", "rotation_step_id"},
    "risk_reservations": {"intent_id", "active_notional", "active_stop_risk", "state", "strategy_version", "strategy_sleeve", "sleeve_allocation_id", "sleeve_notional_ceiling", "sleeve_stop_risk_ceiling", "incremental_risk"},
    ...
    "rotation_groups": {"run_id", "state", "expires_at", "actual_released_notional", "actual_released_risk", "reconciliation_fingerprint", "registry_snapshot_id", "allocation_id", "decision_fingerprint"},
    ...
    "rotation_group_approvals": {"group_id", "approval_id", "sender_id", "ceiling_fingerprint", "status", "consumed_at"},
