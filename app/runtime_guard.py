...
REQUIRED_RUNTIME_TABLE_COLUMNS = {
    ...
    "approvals": {"proposal_id", "proposal_reference_price", "refreshed_bid", "refreshed_ask", "directional_price_move_bps", "movement_classification", "final_limit_price", "directional_validation_reason"},
