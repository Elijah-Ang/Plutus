...
REQUIRED_RUNTIME_TABLE_COLUMNS = {
    ...
    "order_intents": {"id", "logical_action_key", "client_order_id", "reserved_notional", "reserved_stop_risk", "state", "trading_mode", "strategy_registry_snapshot_id", "strategy_sleeve", "sleeve_allocation_id", "sleeve_notional_ceiling", "sleeve_stop_risk_ceiling", "incremental_risk", "rotation_step_id", "approval_authority_fingerprint"},
    ...
    "approvals": {"proposal_id", "proposal_reference_price", "refreshed_bid", "refreshed_ask", "directional_price_move_bps", "movement_classification", "final_limit_price", "directional_validation_reason", "authority_envelope_json", "authority_fingerprint"},
