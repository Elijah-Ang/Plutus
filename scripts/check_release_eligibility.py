...
from app.formula_versions import (  # noqa: E402
    ...
    PERFORMANCE_LAB_CLASSIFICATION_FORMULA_VERSION,
...
RELEASE_FORMULA_VERSIONS = {
    ...
    "crypto_sizing_schema": CRYPTO_SIZING_SCHEMA_VERSION,
    "crypto_risk": CRYPTO_RISK_FORMULA_VERSION,
    "crypto_risk_schema": CRYPTO_RISK_SCHEMA_VERSION,
    "crypto_strategy": CRYPTO_STRATEGY_FORMULA_VERSION,
    "crypto_strategy_schema": CRYPTO_STRATEGY_SCHEMA_VERSION,
    "crypto_proposal": CRYPTO_PROPOSAL_FORMULA_VERSION,
    "crypto_proposal_schema": CRYPTO_PROPOSAL_SCHEMA_VERSION,
    "crypto_profitability": CRYPTO_PROFITABILITY_FORMULA_VERSION,
    "crypto_profitability_schema": CRYPTO_PROFITABILITY_SCHEMA_VERSION,
    "cross_asset_allocation": CROSS_ASSET_ALLOCATION_FORMULA_VERSION,
    "cross_asset_allocation_schema": CROSS_ASSET_ALLOCATION_SCHEMA_VERSION,
    "performance_lab_classification": PERFORMANCE_LAB_CLASSIFICATION_FORMULA_VERSION,
    "performance_lab_classification_schema": PERFORMANCE_LAB_CLASSIFICATION_SCHEMA_VERSION,
    "fixed_point_accounting": FIXED_POINT_ACCOUNTING_VERSION,
    "fixed_point_accounting_schema": FIXED_POINT_ACCOUNTING_SCHEMA_VERSION,
}
